...
## Installation
Type `git clone https://github.com/cxxszz/LP_MP.git` for downloading, then `cd LP_MP` and `git submodule update --init --remote --recursive` for downloading dependencies and finally `cmake .` for building.
